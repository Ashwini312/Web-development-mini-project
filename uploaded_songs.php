...
<head>
	<title>Music Gallery | Uploaded Songs</title>
...
<center><b><div class="alert alert-primary" role="alert">
  Most featured songs...<a href="#" class="alert-link">Listen to music </a>. And have fun.
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:example@email.com" class="text-dark">admin@musicgallery.com</a>
								</p>
							</div>
						</div>
					</div>
	...
	<div class="cpy-right text-center">
		<p>© 2021 Music Gallery. All rights reserved</p>
	</div>
    <!-- //copyright -->
